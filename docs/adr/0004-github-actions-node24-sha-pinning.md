...
| `aquasecurity/trivy-action` | `@v0.30.0` *(Amended by [ADR-0012](0012-trivy-action-supply-chain-remediation-and-sha-pinning.md) to `@v0.36.0`)* | `6c175e9c4083a92bbca2f9724c8a5e33bc2d97a5` *(Updated in ADR-0012)* |
